...
const flights = [
  { id: 1, company: "Türk Hava Yolları", departureTime: "07:30", arrivalTime: "09:15", flightNumber: "TK2154" },
  { id: 2, company: "Pegasus", departureTime: "10:45", arrivalTime: "12:30", flightNumber: "PC1204" },
  { id: 3, company: "SunExpress", departureTime: "14:20", arrivalTime: "16:05", flightNumber: "XQ1182" },
  { id: 4, company: "AnadoluJet", departureTime: "18:50", arrivalTime: "20:35", flightNumber: "TK7760" }
];

const buses = [
  { id: 1, company: "Metro Turizm", departureTime: "08:00", arrivalTime: "18:30", busNumber: "MT343" },
  { id: 2, company: "Kamil Koç", departureTime: "10:30", arrivalTime: "21:00", busNumber: "KK567" },
  { id: 3, company: "Pamukkale Turizm", departureTime: "13:00", arrivalTime: "23:30", busNumber: "PT765" },
  { id: 4, company: "Nilüfer Turizm", departureTime: "16:15", arrivalTime: "02:45", busNumber: "NT233" },
  { id: 5, company: "Varan Turizm", departureTime: "20:00", arrivalTime: "06:30", busNumber: "VR112" },
  { id: 6, company: "Has Turizm", departureTime: "22:30", arrivalTime: "09:00", busNumber: "HT478" }
];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex justify-between mb-2">
              <span className={`font-medium ${step >= 1 ? "text-blue-600" : "text-gray-400"}`}>1. Tarih</span>
              <span className={`font-medium ${step >= 2 ? "text-blue-600" : "text-gray-400"}`}>2. Otel</span>
              <span className={`font-medium ${step >= 3 ? "text-blue-600" : "text-gray-400"}`}>3. Ulaşım</span>
              <span className={`font-medium ${step >= 4 ? "text-blue-600" : "text-gray-400"}`}>4. Yolcu Bilgileri</span>
              <span className={`font-medium ${step >= 5 ? "text-blue-600" : "text-gray-400"}`}>5. Ödeme</span>
            </div>
          ...
          {step === 2 && (
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-2xl font-semibold text-blue-700 mb-4">Otel Seçimi</h2>
              <p className="text-gray-600 mb-6">
                Seçtiğiniz tarihler için aşağıdaki 5 yıldızlı otellerden birini seçiniz.
              </p>
              ...
              <div className="grid md:grid-cols-1 gap-4 mb-6">
                {hotels.map((hotel) => (
                  <div 
                    key={hotel.id} 
                    className={`border rounded-lg overflow-hidden cursor-pointer transition-all hover:shadow-md ${selectedHotel?.id === hotel.id ? 'ring-2 ring-blue-500' : ''}`}
              ...
              {selectedHotel && (
                <div>
                  <h3 className="text-xl font-semibold text-blue-700 mb-4">Oda Seçimi</h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-6">
                    {selectedHotel.roomTypes.map((room) => (
                      <div 
                        key={room.id} 
                        className={`border rounded-lg overflow-hidden cursor-pointer hover:shadow-md ${selectedRoom?.id === room.id ? 'ring-2 ring-blue-500' : ''}`}
                        ...
                        <div className="p-4">
                          ...
                          <div className="mt-2">
                            <div className="flex items-center">
                              <Bed size={16} className="text-blue-500 mr-1" />
          ...
          {step === 3 && (
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-2xl font-semibold text-blue-700 mb-4">Ulaşım Seçimi</h2>
              <p className="text-gray-600 mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div 
                  className={`border rounded-lg p-6 cursor-pointer hover:shadow-md ${transportType === 'flight' ? 'ring-2 ring-blue-500 bg-blue-50' : ''}`}
                ...
                <div 
                  className={`border rounded-lg p-6 cursor-pointer hover:shadow-md ${transportType === 'bus' ? 'ring-2 ring-blue-500 bg-blue-50' : ''}`}
              ...
              {transportType && (
                <>
                  ...
                  <div className="mb-4">
                    <p className="text-gray-600 mb-4">
                      Gidiş tarihiniz için uygun {transportType === 'flight' ? 'uçuşları' : 'otobüs seferlerini'} inceleyebilirsiniz:
                    </p>

                    <div className="border rounded-lg overflow-hidden mb-6">
                      <div className="bg-gray-100 px-4 py-2 font-semibold grid grid-cols-4">
                        <div>Firma</div>
                        <div>Kalkış</div>
                        <div>Varış</div>
                      ...
                      <div className="divide-y">
                        {(transportType === 'flight' ? flights : buses).map((item) => (
                          <div 
                            key={item.id}
                            className={`px-4 py-3 grid grid-cols-4 hover:bg-blue-50 cursor-pointer ${selectedTransport?.id === item.id ? 'bg-blue-50' : ''}`}
              ...
              <div className="mt-8 bg-blue-50 p-4 rounded-md">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-blue-700 font-medium">
                      {selectedHotel?.name}, {selectedRoom?.name}, {transportType ? (transportType === 'flight' ? 'Uçak' : 'Otobüs') : 'Ulaşım seçilmedi'}
                    </p>
                  </div>
                  <div className="flex gap-2">
                    <Button 
          ...
          {step === 4 && (
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-2xl font-semibold text-blue-700 mb-4">Yolcu Bilgileri</h2>
              <p className="text-gray-600 mb-6">
                  ...
                  <div className="mt-8 bg-blue-50 p-4 rounded-md">
                    <div className="flex justify-between items-center">
                      <div>
                        <p className="text-gray-600">Seçilen Bilgiler:</p>
                        <p className="text-blue-700 font-medium">
                          {formatDate(checkInDate)} - {formatDate(checkOutDate)}, {selectedHotel?.name}
                        </p>
                      </div>
                      <div className="flex gap-2">
                        <Button 
          ...
          {step === 5 && (
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-2xl font-semibold text-blue-700 mb-4">Ödeme Bilgileri</h2>
              ...
              <div className="bg-gray-50 p-4 rounded-md mb-6">
                ...
                <div className="flex justify-between font-semibold text-lg">
                  ...
                  <span className="text-blue-700">5.680 TL</span>
                </div>
